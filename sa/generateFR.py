...
files = glob('sa/cmi/*csv', recursive=True)
...
d24 = d[d.date.dt.year.isin([2024])].drop_duplicates(subset=['date'])

d = pd.concat([d22,d23, d24])
plt.figure()
...
d.to_csv('sa/cmi/FR.csv', index=False)
