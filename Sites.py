...
lats = [-23.5844, -24.7288, -24.39278, -22.103936]
lons = [-64.5066, -65.4095, -65.76806, -65.599923]
alts = [401, 1233, 3355 , 3500]

lats_init = [-23.55, -24.74, -24.40, -22.10, ]
lons_init = [-64.55, -65.45,  -65.7, -65.50,]
sites = ['YU','SA','LQ', 'ERO']
